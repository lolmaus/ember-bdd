...
declare module 'miragejs' {
  ...
  export function belongsTo<K extends string>(key?: K, options?: RelationshipOptions): BelongsTo<K>;
  export function belongsTo<K extends string>(options?: RelationshipOptions): BelongsTo<K>;

  /** Declares a one-to-many relationship to another Mirage model type. */
  export function hasMany<K extends string>(key?: K, options?: RelationshipOptions): HasMany<K>;
  export function hasMany<K extends string>(options?: RelationshipOptions): HasMany<K>;
}
...
declare module 'miragejs/-types' {
   ...
   */
  export type Instantiate<Registry, ModelName extends keyof Registry> = ModelInstance<
    {
      ...
      [Model in ModelName]: {
        [Key in keyof Registry[Model]]: InstantiateValue<Registry, Registry[Model][Key]>;
      };
    }[ModelName]
  >;
  ...
  type InstantiateIfDefined<Registry, ModelName> = ModelName extends keyof Registry
   ...
   */
  export type Registry<Models extends AnyModels, Factories extends AnyFactories> = {
...
declare module 'miragejs/server' {
   ...
   */
  export function createServer<Models extends AnyModels, Factories extends AnyFactories>(
...
declare module 'miragejs/orm/schema' {
  ...
  export default class Schema<Registry extends AnyRegistry> {
    ...
    find<K extends keyof Registry>(type: K, id: string): Instantiate<Registry, K> | null;

    find<K extends keyof Registry>(type: K, ids: string[]): Collection<Instantiate<Registry, K>>;
    ...
    where<K extends keyof Registry>(
      type: K,
      attributes: Partial<Instantiate<Registry, K>> | ((item: Instantiate<Registry, K>) => unknown)
    ): Collection<Instantiate<Registry, K>>;

    /** Returns a collection of all known records of the given type */
    all<K extends keyof Registry>(type: K): Collection<Instantiate<Registry, K>>;

    /** Returns an empty collection of the given type */
    none<K extends keyof Registry>(type: K): Collection<Instantiate<Registry, K>>;
